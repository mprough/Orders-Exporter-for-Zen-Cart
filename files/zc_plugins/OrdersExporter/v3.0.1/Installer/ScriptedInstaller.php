    ...
    protected function executeInstall(): bool
    {
        ...
        $this->executeInstallerSql(
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES
                ('Installed version', 'PLUGIN_ORDERS_EXPORTER_VERSION', '3.0.1', 'Installed Orders Exporter version.', {$this->cgi}, 0, 'zen_cfg_select_option(array(\'3.0.1\'),'),
        ...
        $this->executeInstallerSql(
            "UPDATE " . TABLE_CONFIGURATION . "
                SET configuration_value = '3.0.1',
                    set_function = 'zen_cfg_select_option(array(\'3.0.1\'),'
